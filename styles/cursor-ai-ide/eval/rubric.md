# Evaluation rubric — `cursor-ai-ide`
...
- 20: Uses `pack/styles/cursor-ai-ide/DESIGN.md`, tokens, capsules, and eval files explicitly.
...
When reviewing, name the exact local files used. If the output cannot point back to `pack/styles/cursor-ai-ide/DESIGN.md`, a token file, and at least one capsule, treat the style-system usage as incomplete.
