# Evaluation rubric — `perplexity-answer-engine`
...
- 20: Uses `pack/styles/perplexity-answer-engine/DESIGN.md`, tokens, capsules, and eval files explicitly.
...
When reviewing, name the exact local files used. If the output cannot point back to `pack/styles/perplexity-answer-engine/DESIGN.md`, a token file, and at least one capsule, treat the style-system usage as incomplete.
