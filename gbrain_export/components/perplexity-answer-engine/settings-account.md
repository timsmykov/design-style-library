---
title: Design Style Component — perplexity-answer-engine / settings-account
type: design-style-component
style_id: perplexity-answer-engine
component_id: settings-account
component_type: settings
confidence: extracted
repo_path: styles/perplexity-answer-engine/components/capsules/settings-account.md
...
Intents: settings, answer search UI

Aliases: settings account

Repo source: `styles/perplexity-answer-engine/components/capsules/settings-account.md`
