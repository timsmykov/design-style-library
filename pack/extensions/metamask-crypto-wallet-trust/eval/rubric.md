# Evaluation rubric — `metamask-crypto-wallet-trust`
...
- 20: Uses `pack/styles/metamask-crypto-wallet-trust/DESIGN.md`, tokens, capsules, and eval files explicitly.
...
When reviewing, name the exact local files used. If the output cannot point back to `pack/styles/metamask-crypto-wallet-trust/DESIGN.md`, a token file, and at least one capsule, treat the style-system usage as incomplete.
