# Evaluation rubric — `notion-document-os`
...
- 20: Uses `pack/styles/notion-document-os/DESIGN.md`, tokens, capsules, and eval files explicitly.
...
When reviewing, name the exact local files used. If the output cannot point back to `pack/styles/notion-document-os/DESIGN.md`, a token file, and at least one capsule, treat the style-system usage as incomplete.
