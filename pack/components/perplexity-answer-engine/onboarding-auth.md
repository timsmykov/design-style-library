---
title: Design Style Component — perplexity-answer-engine / onboarding-auth
type: design-style-component
style_id: perplexity-answer-engine
component_id: onboarding-auth
component_type: auth_onboarding
confidence: extracted
repo_path: styles/perplexity-answer-engine/components/capsules/onboarding-auth.md
...
Component: `onboarding-auth`

Mediums: web_app, answer_engine

Intents: signup, answer search UI

Aliases: onboarding auth

Repo source: `styles/perplexity-answer-engine/components/capsules/onboarding-auth.md`

## Capsule

# Onboarding Auth
## Use when
Use this component for signup login verify account onboarding upload download in an answer-first, source-backed interface.
## Structure
```text
Component
├── concise label/title
...
## Evidence
- Screenshot-derived facts: `styles/perplexity-answer-engine/components/extracted/from-mobbin-screenshots/onboarding-auth`.
