---
title: Design Style Component — perplexity-answer-engine / pro-upgrade-pricing
type: design-style-component
style_id: perplexity-answer-engine
component_id: pro-upgrade-pricing
component_type: pricing_monetization
confidence: extracted
repo_path: styles/perplexity-answer-engine/components/capsules/pro-upgrade-pricing.md
...
Component: `pro-upgrade-pricing`

Mediums: web_app, answer_engine

Intents: pro, answer search UI

Aliases: pro upgrade pricing

Repo source: `styles/perplexity-answer-engine/components/capsules/pro-upgrade-pricing.md`

## Capsule

# Pro Upgrade Pricing
## Use when
Use this component for pro upgrade subscribe plan billing checkout in an answer-first, source-backed interface.
## Structure
```text
Component
├── concise label/title
...
## Evidence
- Screenshot-derived facts: `styles/perplexity-answer-engine/components/extracted/from-mobbin-screenshots/pro-upgrade-pricing`.
