# Worker Prompt — Notion Document OS
...
- card_id: t_a6b2ffb9
- component: notion-document-os
- owner_mode: implementation-worker

## Рабочее место

- Worktree/root: `/root/hermes-workspace/design-style-library-worktrees/notion-document-os`
- Branch: `style/notion-document-os-wave01`
- Target pack: `styles/notion-document-os/`
- Generated Gbrain slices: `gbrain_export/components/notion-document-os/`
...
Build a draft no-login style pack for **Notion Document OS**. Mirror the Anthropic pipeline as much as feasible in one worker pass.
...
2. Save local screenshots/sections/flows under `styles/notion-document-os/evidence/mobbin/...`. Target 80+ local refs if feasible; truth beats quota.
...
5. Capture public no-login evidence for `https://www.notion.com/` and `https://www.notion.com/pricing` if accessible: DOM/CSS/CDP/screenshots under `evidence/web/...` or `evidence/web/original-code/` consistently.
...
Allowed paths:
- `styles/notion-document-os/`
- `gbrain_export/components/notion-document-os/`
